...
namespace ZFCTAPI.Services.Messages
{
    public partial class Tokenizer : ITokenizer
    {
        ...
        public Tokenizer(ISettingService settingService)
        {
        ...
        {
            MessageTemplatesSettings settings = _settingService.LoadSetting<MessageTemplatesSettings>();
            var _stringComparison = settings.CaseInvariantReplacement ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal;
